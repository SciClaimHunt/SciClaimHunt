...
class BertaWithElementwiseOperations(nn.Module):
    def __init__(self, model_name, hidden_size=1024, num_classes=2):
        super(BertaWithElementwiseOperations, self).__init__()
...
def load_train_objs(train_dataset,dev_dataset,test_dataset):
    ...
    model = BertaWithElementwiseOperations(model_name='bert-large-uncased')
